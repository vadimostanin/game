...
public class WorldBoundsDraw implements IDisposablePropertyListener, IDraw
{
...
//		mBackground.setWrap( TextureWrap.Repeat, TextureWrap.Repeat );
	    ...
	    Gdx.gl.glViewport( 0, 0, 1280, 540 );
...
//						mBatch.setColor( 1.0f, 1.0f, 1.0f, mScales[copy_i] );
		...
		Texture t = Utils.screenShoot( 0, 0, 1280, 540 );
		Utils.saveTexture( t, "t.png" );
		fbo.end(0, 0, 9600, 540);
	}
